...
class DeserializerTests: BaseDeserializerTests {
        ...
        /*
         {
            ...
            "data": {
                ...
                "member": {
                    "id": "82",
                    "account": "3140357046@twitter.com",
                    "name": "Amanda Zales",
                    "gender": "",
                    "profile_image_urls": {
                        "default": "http://pbs.twimg.com/profile_images/584728878800773121/W_F6f07D_400x400.jpg",
                        "mini": "http://pbs.twimg.com/profile_images/584728878800773121/W_F6f07D_normal.jpg",
                        "small": "http://pbs.twimg.com/profile_images/584728878800773121/W_F6f07D_bigger.jpg",
                        "normal": "http://pbs.twimg.com/profile_images/584728878800773121/W_F6f07D_200x200.jpg",
                        "large": "http://pbs.twimg.com/profile_images/584728878800773121/W_F6f07D_400x400.jpg"
                    },
                    "email": "3140357046@twitter.com"
                },
                "content": {
                    "subject": "Which dessert looks yummy?",
                    "image": {
                        "id": "9222",
                        "member_id": "82",
                        "status": "OK",
                        "url": "http://cdn.flin.gy/fling/f80c08dd829acf734fa4f68c56173f49.jpg",
                        "thumb_url": "http://cdn.flin.gy/fling/thumb/f80c08dd829acf734fa4f68c56173f49.jpg"
                    }
                },
                "options": {
                    "position_0": {
    ...
    func testJSONDeserializerForKeyPathSuccess() {
        ...
        self.measureBlock {
            let result = JSONDeserializer(options: .AllowFragments).deserialize(self.data)
            let outcome:String? = JSONDeserializer.parse(result.outcome, forKeyPath: "data.content.subject")
    ...
    func testJSONDeserializerForSingleKeyPathSuccess() {
        self.measureBlock {
            let result = JSONDeserializer(options: .AllowFragments).deserialize(self.data)
            let success:Bool? = JSONDeserializer.parse(result.outcome, forKeyPath: "success")
